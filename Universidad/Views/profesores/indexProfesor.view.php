            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header clearfix">
                        <a href="createProfesor.php" class="btn btn-success float-right">Agregar Profesor</a>
                        ...
                        <tbody>
                            ...
                            foreach ($profesores as $profesor) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="editarProfesor.php?id=<?= $profesor->id; ?>" class="btn btn-warning btn-sm">Editar</a>
                                            <a href="eliminarProfesor.php?id=<?= $profesor->id; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                                        </div>
                                    </td>
                                </tr>
