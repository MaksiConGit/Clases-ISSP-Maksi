...
<div class="loader-track">
    ...
    <div class="container mt-5">
        ...
        <div class="btn-group mb-2 mr-2 col-4 container">
            ...
            <h2>Cursos</h2>
            <button class="btn  btn-primary dropdown-toggle m-l-20" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $año_seleccionado ? $año_seleccionado : 'Año'?></button>
            <div class="dropdown-menu">

            <?php
                foreach (Curso::años() as $año) {

                    if ($año_seleccionado) {

                        if ($año != $año_seleccionado) { ?>
                            <a class="dropdown-item" href="indexCurso.php?pagina=1&año=<?=$año?>"><?=$año . "°"?></a>
                        <?php } ?>
            ...
            <?php } ?>
            <a class="dropdown-item" href="indexCurso.php?pagina=1">Todos</a>
            </div>
            </div>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end">
                ...
                <a class="page-link" href="indexCurso.php?pagina=<?=$pagina-1?>">Previous</a>
                </li>
                
                <?php
                                    
                    for ($i=1; $i <= count($paginas_cursos); $i++) { ?> 
                        ...
                        <li class="page-item <?= ($i == $pagina) ? 'active' : '' ?>">
                            ...
                            if ($año_seleccionado) { ?>
                                ...
                                <a class="page-link" href="indexCurso.php?pagina=<?=$i?>&año=<?=$año_seleccionado?>"><?=$i?></a>

                            <?php }
                            else { ?>
                                <a class="page-link" href="indexCurso.php?pagina=<?=$i?>"><?=$i?></a>
                ...
                <li class="page-item <?= ($pagina == count($paginas_cursos)) ? 'disabled' : '' ?>">
                <a class="page-link" href="indexCurso.php?pagina=<?=$pagina+1?>">Next</a>
                </li>
            </ul>
        </nav>
        ...
        <?php
            ...
            foreach ($paginas_cursos[$pagina-1] as $curso) { ?>
        
            <div class="col-md-6 col-xl-4">
                <a href="editarCurso.php?id=<?= $curso->id; ?>">


                <div class="card">
                    <!-- <img class="img-fluid card-img-top" src="../Images/física-e1534938838719.jpg" alt="Card image cap"> -->
                    <div class="card-header">
                    <h5 class="card-title"><?=$curso->nombre."°".$curso->division?></h5>
                    </div>
                    <div class="card-body">
                        ...
                        <p class="card-text"><small class="text-muted">Última vez editado: <?=$curso->updated_at ? $curso->updated_at : 'Nunca'?></small></p>
                    </div>
                </div>
                </a>
            </div>
