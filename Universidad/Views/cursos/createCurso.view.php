                  ...
                  <div class="d-flex flex-wrap col-12">
                      ...
                      foreach ($materias as $indice => $materia) { ?>
                          <div class="custom-control custom-checkbox mb-3 col-6 col-md-4 col-lg-4">
                              <input type="checkbox" name="materias_id[]" value="<?=$materia->id?>" class="custom-control-input" id="customControlValidation<?=$indice?>">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="enviarFormulario" class="btn btn-primary">Guardar cambios</button>
                            </div>
                        </div>
                    </div>
                </div>
