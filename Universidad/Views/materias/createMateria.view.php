  ...
  <div class="container d-flex justify-content-center align-items-center mt-4 col-8" style="min-height: calc(100vh - 120px);">
    <div class="container p-4 col-md-8 col-lg-10 border border-primary">
        ...
        <form class="needs-validation" method="POST">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">Guardar</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">¿Está seguro que quiere crear esta materia?</h5>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="enviarFormulario" class="btn btn-primary">Guardar</button>
                            </div>
                        </div>
                    </div>
                </div>
